...
public class PeerIdentity {
    ...
    public String toString() {
        return "PeerIdentity{" +
               ...
               ", destPort=" + destPort +
               ", vcnMetadata=" + Arrays.toString(vcnMetadata) +
               ", sgwSourceInetAddress='" + sgwSourceInetAddress + '\'' +
               ", sgwPeSourceInetAddress='" + sgwPeSourceInetAddress + '\'' +
               ", vcnOcid='" + vcnOcid + '\'' +
               ", vcnPeOcid='" + vcnPeOcid + '\'' +
               ", authority='" + authority + '\'' +
               '}';
    ...
    static class Builder implements io.helidon.common.Builder<PeerIdentity> {
